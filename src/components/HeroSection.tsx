...
import { MapPin, Download, Linkedin, Mail, Phone } from "lucide-react";
      ...
      <div className="container max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="w-36 h-36 md:w-44 md:h-44 rounded-full overflow-hidden border-2 border-primary/30 animate-pulse-glow">
              <img src={profileImg} alt="Mohamed Mamdouh" className="w-full h-full object-cover" />
            </div>
          </motion.div>
